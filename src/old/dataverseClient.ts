...
export class DataverseClient {
  ...
  public async addBasicDataset(
    dataverseAlias: string,
    datasetInformation: BasicDatasetInformation,
  ...
  public async getMetricByCountry(
    ...
    const url = `${this.host}/api/datasets/${datasetId}/makeDataCount/${metricType.toString()}${
      yearMonth ? '/' + yearMonth : ''
    }${countryQueryParam}`;
    return this.getRequest(url);
  }
  ...
  public async publishDataset(
    datasetId: string,
    versionUpgradeType: DatasetVersionUpgradeType = DatasetVersionUpgradeType.MAJOR,
  ): Promise<AxiosResponse> {
  ...
  private async getRequest(
    url: string,
    options: { params?: object; headers?: DataverseHeaders; responseType?: ResponseType } = {
      headers: this.getHeaders(),
    },
  ): Promise<AxiosResponse> {
  ...
  private async postRequest(
    url: string,
    data: string | object,
    options: { params?: object; headers?: DataverseHeaders } = { headers: this.getHeaders() },
  ): Promise<AxiosResponse> {
