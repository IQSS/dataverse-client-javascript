...
const transformPayloadToFileDataTable = (fileDataTablePayload: any): FileDataTable => {
  return {
    ...
    ...(fileDataTablePayload.recordsPerCase && { recordsPerCase: fileDataTablePayload.recordsPerCase }),
  ...
  fileDataVariablesPayload.forEach(function (fileDataVariablePayload: any) {
    fileDataVariables.push({
      ...
      ...(fileDataVariablePayload.variableIntervalType && {
        variableIntervalType: fileDataVariablePayload.variableIntervalType as FileDataVariableIntervalType,
      }),
      ...
      ...(fileDataVariablePayload.formatCategory && { formatCategory: fileDataVariablePayload.formatCategory }),
      ...
      ...(fileDataVariablePayload.fileEndPosition && { fileEndPosition: fileDataVariablePayload.fileEndPosition }),
      ...
      ...(fileDataVariablePayload.variableMetadata && {
        variableMetadata: transformPayloadToFileVariableMetadata(fileDataVariablePayload.variableMetadata),
      }),
      ...(fileDataVariablePayload.invalidRanges && {
        invalidRanges: transformPayloadToDataVariableInvalidRanges(fileDataVariablePayload.invalidRanges),
      }),
      ...
      ...(fileDataVariablePayload.variableCategories && {
        variableCategories: transformPayloadToFileDataVariableCategories(fileDataVariablePayload.variableCategories),
      }),
    });
  });
...
// eslint-disable-next-line  @typescript-eslint/no-explicit-any
const transformPayloadToFileVariableMetadata = (fileVariableMetadataPayload: any): FileDataVariableMetadata[] => {
  ...
  fileVariableMetadataPayload.forEach(function (fileVariableMetadataElementPayload: any) {
    fileDataVariableMetadata.push({
      ...
      ...(fileVariableMetadataElementPayload.label && { label: fileVariableMetadataElementPayload.label }),
      ...
      ...(fileVariableMetadataElementPayload.universe && { universe: fileVariableMetadataElementPayload.universe }),
      ...(fileVariableMetadataElementPayload.notes && { notes: fileVariableMetadataElementPayload.notes }),
...
const transformPayloadToFileDataVariableCategoryMetadatas = (
  ...
  categoryMetadatasPayload.forEach(function (categoryMetadataPayload: any) {
    fileDataVariableCategoryMetadatas.push({
      ...
      ...(categoryMetadataPayload.categoryValue && { categoryValue: categoryMetadataPayload.categoryValue }),
    });
  });
...
const transformPayloadToDataVariableInvalidRanges = (
  ...
  dataVariableInvalidRangesPayload.forEach(function (dataVariableInvalidRangePayload: any) {
    dataVariableInvalidRanges.push({
      ...(dataVariableInvalidRangePayload.beginValue && { beginValue: dataVariableInvalidRangePayload.beginValue }),
      ...
      ...(dataVariableInvalidRangePayload.endValue && { endValue: dataVariableInvalidRangePayload.endValue }),
...
const transformPayloadToFileDataVariableCategories = (
  ...
  fileDataVariableCategoriesPayload.forEach(function (fileDataVariableCategoryPayload: any) {
    fileDataVariableCategories.push({
      ...(fileDataVariableCategoryPayload.label && { label: fileDataVariableCategoryPayload.label }),
      ...(fileDataVariableCategoryPayload.value && { value: fileDataVariableCategoryPayload.value }),
      isMissing: fileDataVariableCategoryPayload.isMissing,
      ...(fileDataVariableCategoryPayload.frequency && { frequency: fileDataVariableCategoryPayload.frequency }),
    });
  });
