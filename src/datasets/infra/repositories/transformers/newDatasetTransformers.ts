  ...
  return {
    datasetVersion: {
      ...
      metadataBlocks: transformMetadataBlockModelsToRequestPayload(
        newDataset.metadataBlockValues,
        metadataBlocks
      )
    }
  }
...
export const transformMetadataBlockModelsToRequestPayload = (
  ...
  newDatasetMetadataBlocksValues.forEach(function (
    newDatasetMetadataBlockValues: NewDatasetMetadataBlockValuesDTO
  ) {
...
export const transformMetadataFieldValueToRequestPayload = (
  ...
  if (metadataBlockFieldInfo.multiple) {
    ...
    if (typeof newDatasetMetadataChildFieldValues[0] == 'string') {
      ...
      value = []
      ;(newDatasetMetadataChildFieldValues as NewDatasetMetadataChildFieldValueDTO[]).forEach(
        function (childMetadataFieldValue: NewDatasetMetadataChildFieldValueDTO) {
...
export const transformMetadataChildFieldValueToRequestPayload = (
  ...
  for (const metadataChildFieldKey of Object.keys(newDatasetMetadataChildFieldValue)) {
    ...
    const value: string = newDatasetMetadataChildFieldValue[
